...
<table class="table table-hover">
  <thead>
    <tr>
      ...
      <th scope="col" width="200px"><a href="/main/index?p=<?php echo $current_page; ?>&f_order=name&order=<?php echo $norder; ?>">Имя пользователя</a></th>
      <th scope="col" width="150px"><a href="/main/index?p=<?php echo $current_page; ?>&f_order=email&order=<?php echo $eorder; ?>">E-mail</a></th>
      <th scope="col" width="390px">Текст задчи</th>
      <th scope="col" width="150px"><a href="/main/index?p=<?php echo $current_page; ?>&f_order=status&order=<?php echo $sorder; ?>">Статус</a></th>
    </tr>
  </thead>
  <tbody>
